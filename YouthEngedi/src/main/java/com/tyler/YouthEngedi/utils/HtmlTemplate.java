...
public class HtmlTemplate {
    ...
    public static String roleRequestUpgrade() {
        return String.format("""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    public static String roleRequestApprovedRequest(String name, String adminName, String email, Role requestedRole, String adminComment) {
        return String.format("""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    """,
                ...
                adminName,
                email,
                adminComment == null || adminComment.isBlank() ? "No reason provided." : adminComment);
    }

    public static String roleRequestRejectedRequest(String name,String adminName,String email,Role requestedRole,String adminComment){
        return String.format("""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    public static String adminRequest(String name, String email, Set<Role> roles, Role requestedRole, String userReason, LocalDateTime requestedAt, RequestStatus requestStatus) {
        return String.format("""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    """,
                ...
                roles,
                requestedRole,
                userReason == null || userReason.isBlank() ? "No reason provided." : userReason,
                requestedAt,
                requestStatus
        );
    }
